...
import io.github.vivitoto.vanga.image.wasm.messages.getType
import io.github.vivitoto.vanga.image.wasm.messages.initMessage
...
class ImageWorker {
    ...
    private val worker = Worker("vangaImageWorker.js")
