...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_decode(JNIEnv *env,
  ...
  if (!decoded) {
    vanga_throw_jvm_vips_exception(env);
    vips_thread_shutdown();
    return nullptr;
  }

  jobject jvm_image = vanga_to_jvm_handle(env, decoded, internal_buffer);
...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_decodeFromFile(JNIEnv *env,
  ...
  vips_thread_shutdown();
  jobject jvm_handle = vanga_to_jvm_handle(env, decoded, nullptr);
...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_thumbnail(
  ...
  jobject jvm_handle = vanga_to_jvm_handle(env, thumbnail, nullptr);
  if (jvm_handle == nullptr) {
...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_thumbnailBuffer(JNIEnv *env,
  ...
  vips_thread_shutdown();
  jobject jvm_handle = vanga_to_jvm_handle(env, thumbnail, internal_buffer);
  if (jvm_handle == nullptr) {
    g_object_unref(thumbnail);
    free(internal_buffer);
  }
...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_extractArea(JNIEnv *env,
  ...
  jobject jvm_image = vanga_to_jvm_handle(env, extracted_image, nullptr);
  return jvm_image;
}
...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_resize(JNIEnv *env,
  ...
  jobject jvm_image = vanga_to_jvm_handle(env, resized, nullptr);
  if (jvm_image == nullptr) {
...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_makeHistogram(JNIEnv *env,
  ...
  int bands = vips_image_get_bands(image);
  if (bands != 1 && bands != 4) {
    vanga_throw_jvm_vips_exception_message(env, "unsupported number of image bands");
    return nullptr;
  }
  ...
  jobject jvm_image = vanga_to_jvm_handle(env, histogram_normalized, nullptr);
  if (jvm_image == nullptr) {
...
JNIEXPORT jobject JNICALL Java_io_github_vivitoto_vanga_image_VipsImage_mapLookupTable(JNIEnv *env,
  ...
  jobject jvm_image = vanga_to_jvm_handle(env, transformed, nullptr);
  if (jvm_image == nullptr) {
