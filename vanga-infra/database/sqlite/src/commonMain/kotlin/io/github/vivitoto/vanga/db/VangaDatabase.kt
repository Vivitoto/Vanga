...
import io.github.vivitoto.vanga.db.migrations.AppMigrations
import io.github.vivitoto.vanga.db.migrations.MigrationResourcesProvider
import io.github.vivitoto.vanga.db.migrations.OfflineMigrations
import javax.sql.DataSource


class VangaDatabase(databaseDir: String) {
    val app: Database
    val offline: Database
    val offlineReadOnly: Database

    init {
        val appUrl = "jdbc:sqlite:${databaseDir}/vanga.sqlite"
