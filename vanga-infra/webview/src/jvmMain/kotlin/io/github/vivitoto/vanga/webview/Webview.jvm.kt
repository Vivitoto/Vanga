...
import io.github.vivitoto.vanga.jni.Managed
import io.github.vivitoto.vanga.jni.NativePointer
import io.github.vivitoto.vanga.webview.WebviewCallback.CallbackResponse
...
actual class VangaWebview private constructor(
    ptr: NativePointer,
    ...
    companion object {
        ...
        fun webview(window: Component, onLoad: (VangaWebview) -> Unit) {
            mainLoopExecutor.submit(Callable {
                val ptr = create(window)
                onLoad(VangaWebview(ptr))
            })
        }
