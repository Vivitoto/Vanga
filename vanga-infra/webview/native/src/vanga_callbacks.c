...
void vanga_main_started_callback(webview_t webview, void *data) {
...
void vanga_bind_callback_run(const char *id, const char *req, void *data) {
...
void vanga_interceptor_destroy(void *data) {
...
void vanga_bind_callback_destroy(void *data) {
    bind_callback_t *callback = data;
    JavaVM *jvm = callback->jvm;
    JNIEnv *env = NULL;
    int requires_detach = jvm_attach_if_necessary(jvm, &env);
