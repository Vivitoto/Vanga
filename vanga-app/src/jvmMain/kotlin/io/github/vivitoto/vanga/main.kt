...
import io.github.vivitoto.vanga.AppDirectories.projectDirectories
...
import io.github.vivitoto.vanga.ui.log.LogView
import io.github.vivitoto.vanga.ui.log.LogbackFlowAppender
...
//    loggerContext.getLogger("Exposed").level = Level.DEBUG
    ...
    val logFile = Path.of(projectDirectories.dataDir).resolve("vanga.log").toString()
