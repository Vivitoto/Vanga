...
group = "io.github.vivitoto.vanga"
...
kotlin {
    ...
    wasmJs {
        outputModuleName = "vanga-app"
        browser {
            commonWebpackConfig {
                outputFileName = "vanga-app.js"
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            implementation(projects.vangaUi)
            ...
            implementation(projects.vangaInfra.webview)
        ...
        wasmJsMain.dependencies {
            ...
            implementation(projects.vangaInfra.imageDecoder.wasmImageWorker)
            implementation(projects.vangaInfra.database.wasm)
        }
    }
}
...
val androidVariant = runCatching {
    AndroidVariant.valueOf(
        (project.extraProperties["vanga.android.variant"] as String).uppercase()
    )
}.getOrDefault(AndroidVariant.STANDALONE)

android {
    namespace = "io.github.vivitoto.vanga"
...
compose.desktop {
    application {
        mainClass = "io.github.vivitoto.vanga.MainKt"
        ...
        nativeDistributions {
            ...
            description = "Vanga media library client"
            vendor = "Vanga"
