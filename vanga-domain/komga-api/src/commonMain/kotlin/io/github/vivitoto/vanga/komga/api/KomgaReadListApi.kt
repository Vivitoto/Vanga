...
interface KomgaReadListApi {
    ...
    suspend fun getBookSiblingNext(readListId: KomgaReadListId, bookId: KomgaBookId): VangaBook?
    suspend fun getBookSiblingPrevious(readListId: KomgaReadListId, bookId: KomgaBookId): VangaBook?
}