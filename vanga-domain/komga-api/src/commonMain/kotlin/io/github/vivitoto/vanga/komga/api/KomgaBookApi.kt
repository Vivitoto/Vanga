...
interface KomgaBookApi {
    suspend fun getOne(bookId: KomgaBookId): VangaBook
    ...
    suspend fun getLatestBooks(pageRequest: KomgaPageRequest? = null): Page<VangaBook>
    suspend fun getBooksOnDeck(
        libraryIds: List<KomgaLibraryId>? = null,
        pageRequest: KomgaPageRequest? = null,
    ): Page<VangaBook>

    suspend fun getDuplicateBooks(pageRequest: KomgaPageRequest? = null): Page<VangaBook>
    suspend fun getBookSiblingPrevious(bookId: KomgaBookId): VangaBook?
    suspend fun getBookSiblingNext(bookId: KomgaBookId): VangaBook?
