...
class RemoteBookApi(
    ...
    override suspend fun getBookList(
        ...
        return getVangaBookPage(booksPage)
    }
    ...
    override suspend fun getBookSiblingPrevious(bookId: KomgaBookId): VangaBook? {
        ...
        return book?.let { getVangaBook(it) }
    ...
    private suspend fun getVangaBook(book: KomgaBook): VangaBook {
    ...
    private suspend fun getVangaBookPage(bookPage: Page<KomgaBook>): Page<VangaBook> {
...
fun Page<KomgaBook>.toVangaBookPage(books: List<VangaBook>): Page<VangaBook> {
    return Page(
        content = books,
