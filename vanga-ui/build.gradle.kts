...
group = "io.github.vivitoto.vanga.ui"
version = "0.9.0"
...
kotlin {
    ...
    androidTarget {
        compilerOptions {
            ...
            freeCompilerArgs.addAll(
                "-P",
                "plugin:org.jetbrains.kotlin.parcelize:additionalAnnotation=io.github.vivitoto.vanga.ui.platform.CommonParcelize",
            )
        }
    }
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            api(projects.vangaDomain.core)
            api(projects.vangaDomain.komgaApi)
            api(projects.vangaDomain.offline)
...
android {
    namespace = "io.github.vivitoto.vanga.ui"
