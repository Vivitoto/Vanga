package io.github.vivitoto.vanga.ui.dialogs.collectionadd
...
private fun Header(onDismissRequest: () -> Unit) {
    Column {
        Row(
            ...
            Text("添加到合集", style = MaterialTheme.typography.titleLarge)
...
private fun CollectionEntry(
    ...
    Column(
        ...
        Row(
            ...
            Text("${collection.seriesIds.size} 部作品", style = MaterialTheme.typography.labelLarge)
