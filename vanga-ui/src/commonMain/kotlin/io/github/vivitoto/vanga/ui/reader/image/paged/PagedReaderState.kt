...
import io.github.vivitoto.vanga.ui.reader.image.BookState
...
import io.github.vivitoto.vanga.ui.reader.image.SpreadIndex
...
class PagedReaderState(
    ...
    suspend fun initialize() {
        ...
        appNotifications.add(AppNotification.Normal("分页模式 ${strings.forReadingDirection(readingDirection.value)}"))
    }
