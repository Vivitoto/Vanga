...
import io.github.vivitoto.vanga.image.coil.BookThumbnailRequest
...
import io.github.vivitoto.vanga.ui.dialogs.PosterEditState.ThumbnailType.GENERATED
import io.github.vivitoto.vanga.ui.dialogs.PosterEditState.ThumbnailType.SIDECAR
import io.github.vivitoto.vanga.ui.dialogs.PosterEditState.ThumbnailType.UNKNOWN
import io.github.vivitoto.vanga.ui.dialogs.PosterEditState.ThumbnailType.USER_UPLOADED
...
fun ThumbnailEditCard(
    ...
    ItemCard(
        ...
        val (icon, tooltip) = when (thumbnail.type) {
            USER_UPLOADED -> Icons.Default.CloudDone to "用户上传"
            SIDECAR -> Icons.Default.Folder to "本地封面"
            GENERATED -> Icons.AutoMirrored.Filled.InsertDriveFile to "生成封面"
...
private fun ThumbnailCardContent(
    ...
    Column(
        ...
        Text("${sizeInKb}kB")
        size?.let { Text("宽：${it.width}，高：${it.height}") }
