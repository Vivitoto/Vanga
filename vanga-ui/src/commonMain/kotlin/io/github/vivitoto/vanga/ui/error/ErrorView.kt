...
import io.github.vivitoto.vanga.ui.platform.HorizontalScrollbar
...
fun ErrorView(
    ...
    MaterialTheme(colorScheme = Theme.DARK.colorScheme, shapes = Theme.DARK.shapes) {
