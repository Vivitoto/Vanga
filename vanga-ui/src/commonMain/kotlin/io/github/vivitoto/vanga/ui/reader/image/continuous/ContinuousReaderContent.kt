package io.github.vivitoto.vanga.ui.reader.image.continuous
...
import io.github.vivitoto.vanga.image.ReaderImageResult
...
import io.github.vivitoto.vanga.ui.reader.image.common.ContinuousReaderHelpDialog
...
import io.github.vivitoto.vanga.ui.reader.image.continuous.ContinuousReaderState.BookPagesInterval
...
private fun LazyListScope.continuousPagesLayout(
    ...
    item {
        Box(
            ...
            Text("已到达作品开头", style = MaterialTheme.typography.titleLarge)
        }
    }
    ...
    item {
        Box(
            modifier = Modifier.sizeIn(minHeight = 300.dp, minWidth = 300.dp).fillMaxSize(),
            contentAlignment = Alignment.Center
        ) { Text("已到达作品结尾", style = MaterialTheme.typography.titleLarge) }
    }
